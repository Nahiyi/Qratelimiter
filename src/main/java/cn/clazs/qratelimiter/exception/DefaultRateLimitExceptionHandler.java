 ...
 *
 * <ul>
 *   <li>创建自己的 @RestControllerAdvice 来处理 RateLimitException</li>
 *   <li>通过配置文件禁用：clazs.ratelimiter.exception-handler.enabled=false</li>
 * </ul>
 *
...
@ConditionalOnMissingBean(name = "customRateLimitExceptionHandler")
@ConditionalOnProperty(
        prefix = "clazs.ratelimiter.exception-handler",
        name = "enabled",
        havingValue = "true",
        matchIfMissing = true
)
